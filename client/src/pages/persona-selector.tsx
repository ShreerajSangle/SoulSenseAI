    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-lavender-100 via-lavender-50 to-purple-50 flex items-center justify-center">
        <div className="text-center">
          <div className="w-24 h-24 mx-auto bg-gradient-to-r from-indigo-500 via-purple-600 to-pink-600 rounded-2xl flex items-center justify-center mb-6 shadow-2xl animate-pulse">
    ...
    <div className="min-h-screen bg-gradient-to-br from-lavender-100 via-lavender-50 to-purple-50 relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-12 max-w-6xl">
        ...
        <div className="text-center mb-16">
          <div className="mb-8">
            <div className="w-24 h-24 mx-auto bg-gradient-to-r from-indigo-500 via-purple-600 to-pink-600 rounded-2xl flex items-center justify-center mb-6 shadow-2xl transform hover:scale-105 transition-all duration-300">
              <Sparkles className="text-white text-3xl animate-pulse" />
            </div>
            <h1 className="text-5xl font-bold bg-gradient-to-r from-slate-800 via-purple-700 to-indigo-800 bg-clip-text text-transparent mb-4">
              SoulSense AI
            </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
          <Card 
            className="cursor-pointer hover:shadow-lg transition-all duration-300 border-0 bg-white/80 backdrop-blur-sm hover:bg-white/90"
